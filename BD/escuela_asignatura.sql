...
CREATE TABLE `asignatura` (
  ...
  PRIMARY KEY (`id`),
  KEY `nivel_id_idx` (`nivel_id`),
  KEY `profesor_id_idx` (`profesor_id`),
  CONSTRAINT `nivel_id` FOREIGN KEY (`nivel_id`) REFERENCES `nivel` (`id`),
  CONSTRAINT `profesor_id` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`id`)
